...
void takedata(){
 ...
 {
    printf("\n INSTRUCTIONS \n"
            "\n**>Enter tm in 2400 hours formtimea. example for 10:30 am enter 10030"
            "\n**>Enter Query arrival tms in ascending order, i.e., in real tm arrival manner\n"
            "\nAll tm units are in minutes. \n\n");
    takedata();
    combine();
    DoRR();
    giveoutput();
